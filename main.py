...
def processFile(update,bot,message,file,obten_name,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.sendMessage(-1001730575934,finishInfo+'\n'+filesInfo,parse_mode='html')
        if len(files)>0:
...
def sendTxt(name,files,update,bot):
                ...
                bot.sendFile(-1001730575934,name)
                os.unlink(name)
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        tl_admin_user = os.environ.get('JOSE_752')
...
def main():
    ...
    bot_token = '5931266594:AAGzZ9R3nJJZs219n1qOgJYLuTpWi-V5D74'    
